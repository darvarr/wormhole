...
"""snip_usb_part2.py: It receives from a serial port and forward data to the other one.
"""
...
while True:
    ...
    with open("sniplayer1.log", 'a') as infile:
